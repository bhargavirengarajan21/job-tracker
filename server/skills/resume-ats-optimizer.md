...
## Few-Shot Examples for Keyword Extraction

These examples show EXACTLY how to extract keywords and their variations from a job description. Follow this pattern precisely.

### Example 1 — Software Engineering JD
...
- Proficiency in React (must have)
- REST API integration or RESTful API development
- Git version control
...
{
  "hardSkills": [
    {"keyword": "JavaScript", "priority": "required", "variations": ["JS", "ECMAScript", "ES6"]},
    {"keyword": "React", "priority": "required", "variations": ["React.js", "ReactJS"]},
    {"keyword": "REST API", "priority": "required", "variations": ["RESTful API", "REST APIs", "REST API integration", "API integration", "API development"]},
    {"keyword": "Git", "priority": "required", "variations": ["version control", "GitHub", "GitLab", "source control"]},
    {"keyword": "Node.js", "priority": "preferred", "variations": ["NodeJS", "Node"]},
    {"keyword": "GraphQL", "priority": "preferred", "variations": ["GQL"]}
  ],
  "tools": [
    {"keyword": "Docker", "priority": "preferred", "variations": ["containerization", "containers"]},
    {"keyword": "Kubernetes", "priority": "preferred", "variations": ["K8s", "k8s", "container orchestration"]},
    {"keyword": "AWS", "priority": "preferred", "variations": ["Amazon Web Services", "cloud services", "cloud infrastructure"]}
  ],
  "education": [
    {"keyword": "Bachelor's degree", "priority": "required", "variations": ["BS", "B.S.", "BSc", "Bachelor of Science", "undergraduate degree"]}
  ],
  "experience": [
    {"keyword": "5+ years", "priority": "required", "variations": ["5 years", "five years", "senior-level"]}
  ],
  "softSkills": [],
  "certifications": []
}
...
**Why this is correct:**
- `REST API` has 5 variations because resumes use many forms of this phrase — missing variations causes false negatives
- `AWS` includes "cloud services" because the JD says "AWS or cloud services" — both are equivalent
- `Bachelor's degree` has 5 variations to catch all common abbreviations
- `5+ years` is its own keyword because ATS systems check experience thresholds

---

### Example 2 — Data Science JD
...
- PhD or Master's in Statistics, Math, or CS
```
...
{
  "hardSkills": [
    {"keyword": "Python", "priority": "required", "variations": ["Python 3", "Python programming"]},
    {"keyword": "machine learning", "priority": "required", "variations": ["ML", "deep learning", "statistical modeling", "predictive modeling"]},
    {"keyword": "SQL", "priority": "required", "variations": ["database querying", "MySQL", "PostgreSQL", "database", "query language"]},
    {"keyword": "statistics", "priority": "required", "variations": ["probability", "statistical analysis", "statistical modeling", "quantitative analysis"]},
    {"keyword": "TensorFlow", "priority": "preferred", "variations": ["Keras", "TF"]},
    {"keyword": "PyTorch", "priority": "preferred", "variations": ["torch"]}
  ],
  "tools": [
    {"keyword": "Spark", "priority": "preferred", "variations": ["Apache Spark", "PySpark", "big data"]},
    {"keyword": "Hadoop", "priority": "preferred", "variations": ["HDFS", "MapReduce", "big data"]}
  ],
  "education": [
    {"keyword": "Master's degree", "priority": "preferred", "variations": ["MS", "M.S.", "MSc", "Master of Science"]},
    {"keyword": "PhD", "priority": "preferred", "variations": ["Doctorate", "Ph.D.", "doctoral degree"]}
  ],
  "experience": [],
  "softSkills": [
    {"keyword": "communication", "priority": "preferred", "variations": ["presentation skills", "verbal communication"]}
  ],
  "certifications": []
}
```
...
**Why this is correct:**
- `machine learning` includes `deep learning` as a variation because they are functionally equivalent in most JDs
- `SQL` includes specific database names as variations — a resume may say "PostgreSQL" when JD says "SQL"
- `TensorFlow` and `PyTorch` are separate keywords even though JD says "or" — candidates may have one or both
- `PhD` and `Master's degree` are separate entries since they are different thresholds

---

### Common Variation Mapping (always include these)

| JD Keyword | Required Variations |
|---|---|
| JavaScript | JS, ECMAScript, ES6, ES2015 |
| TypeScript | TS |
| React | React.js, ReactJS |
| Node.js | NodeJS, Node, server-side JavaScript |
| REST API | RESTful API, REST APIs, REST API integration, API integration |
| GraphQL | GQL |
| AWS | Amazon Web Services, cloud services, cloud infrastructure |
| Docker | containerization, containers |
| Kubernetes | K8s, k8s, container orchestration |
| CI/CD | CICD, continuous integration, continuous deployment, DevOps pipeline |
| Machine Learning | ML, deep learning, predictive modeling |
| SQL | database querying, MySQL, PostgreSQL, relational database |
| Bachelor's degree | BS, B.S., BSc, Bachelor of Science, undergraduate |
| Master's degree | MS, M.S., MSc, Master of Science |
